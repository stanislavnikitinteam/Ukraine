...
$( document ).ready(function() {
    $('.btn').on('click', function (event) {
		$('button.btn').addClass('main__span2')
		$('button.btn').removeClass('main__span')
	})
});

$(document).click(function(event) {
	if (!$(event.target).is("button .btn")) {
		$('button.btn').addClass('main__span')
		$('button.btn').removeClass('main__span2')
	}
});